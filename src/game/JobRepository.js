    ...
    constructor() {
        this.jobs = [
            ...
            new Job("黒魔道士", [
                    ...
                    new Spell("アスピル", 20, new MindAttackEffect(180, new MagicDrainFeedback(), (x) => parseInt(x / 20))),
                    new Spell("マホトラ", 10, new MindAttackEffect(90, new MagicDrainFeedback(), (x) => parseInt(x / 20))),
